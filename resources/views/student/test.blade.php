...
@section('content')
    <div class="w-100 h-100" style="position: relative; background-color: #EDE4FF;">
        <div style="height: 10px;"></div>
        <div class="px-4 py-2 w-100 d-flex d-flex justify-content-between align-items-center" style="background-color: #FFE5AD; border: 1px solid #6F61C0; color: #6528F7;">
            <div>
        ...
        <div class="w-100 mt-3" style="position: absolute; display: flex; justify-content: center; align-items: center; height: 68%;">
            ...
            <div class="card h-100 rounded-5 py-3 px-3" style="position: absolute; width: 75%; box-shadow: 0 1px 1px rgba(0,0,0,0.12), 0 2px 2px rgba(0,0,0,0.12);">
                <div class="card-body">
                    <div class="p-3 rounded-4" style="background-color: #6F61C0; color: white; box-shadow: 0px 5px 10px 0px #6F61C0; transform: translateX(-50px);">
        ...
        <div class="w-100" style="position: absolute; bottom: 40px; display: flex; justify-content: center; align-items: center;">
